...
class Expense : NSObject {
    ...
    init( record : CKRecord) {
        ...
        self.interval = record.value(forKey: ExpenseKeys.expenseIntervalKey) as? TimeInterval
    ...
    func createRecord() -> CKRecord {
        ...
        if (self.interval != nil) {
            record.setValue(NSNumber.init(value: self.interval!), forKey: ExpenseKeys.expenseIntervalKey)
        }
